...
if get_Enformer_scores:
    ...
    import modified_get_Enformer_scores_utils
    modified_get_Enformer_scores_utils.chrom_lengths = chrom_lengths
    modified_get_Enformer_scores_utils.centromere_coords = centromere_coords
        ...
        for shift in shift_by:
            ...
            for revcomp in revcomp_decision_i:
                ...
                try:
                    ...
                    if get_Enformer_scores:
                        scores = modified_get_Enformer_scores_utils.get_scores(POS, SVTYPE, SVLEN,

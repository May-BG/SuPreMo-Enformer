...
import argparse
#import get_Enformer_scores_utils  # Import for get_scores function
#import modified_get_Enformer_scores_utils
import modified_get_Enformer_scores_utils_multitracks
...
parser.add_argument('--nrows',
                    ...
                    default = 1000,
                    required = False)
parser.add_argument("--track", type=str,dest="track", help="Specify track to use", default=None)
parser.add_argument("--protocol", type=str, dest="protocol",help="Specify protocol to use", default=None)
parser.add_argument("--cell_type", type=str, dest="cell_type",help="Specify cell type to use", default=None)

parser.add_argument("--binding_factor", type=str, dest="binding_factor",help="Specify binding_factor to use", default=None)
parser.add_argument("--selected_tracks", nargs='+', dest="selected_tracks",help="Specify tacks to use", default=None)
args = parser.parse_args()
...
selected_tracks = args.selected_tracks
binding_factor = args.binding_factor
#track = args.track
__version__ = '1.0'
...
import sys
sys.path.insert(0, 'manual_load_enformer_scripts/')
...
if get_Enformer_scores:
    ...
    import modified_get_Enformer_scores_utils_multitracks
    modified_get_Enformer_scores_utils_multitracks.chrom_lengths = chrom_lengths
    modified_get_Enformer_scores_utils_multitracks.centromere_coords = centromere_coords
        ...
        for shift in shift_by:
            ...
            for revcomp in revcomp_decision_i:
                ...
                try:
                    ...
                    if get_Enformer_scores:
                        scores = modified_get_Enformer_scores_utils_multitracks.get_scores(POS, SVTYPE, SVLEN,
